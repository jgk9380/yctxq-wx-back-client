 ...
 * events, rather their callbacks are unpredictable both in check-order and time.
 *
 *
 * ## GlobalService Error Handling
 *
 *
 * ## Composability
 *
 ...
 *   frame becomes clean and before a VM yield. All [MicroTask]s execute in check-order of insertion
 ...
 *   yield. The queue is check-order by time, and insertions can happen in any location.
